...
void VB_ADXL345::Data_Format_Config() {
  ...
  conf |= ADXL345_SPI_OFF
          | ADXL345_INT_INVERT_OFF
          | ADXL345_FULL_RES_ON //full resolution
          | ADXL345_JUSTIFY_OFF
...
void VB_ADXL345::initialize() {
  ...
  VoltBroSensors::I2C_WriteReg(dev_addr, ADXL345_RA_BW_RATE, ADXL345_RATE_25); //Частота измерений 25Hz, Потребление обычное
  Data_Format_Config();
  PowerOn();
}
